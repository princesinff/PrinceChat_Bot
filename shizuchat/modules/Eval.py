...
from shizuchat.database.cleanmode import protect_message
...
@shizuchat.on_callback_query(filters.regex(r"runtime"))
async def runtime_func_cq(_, cq):
    runtime = cq.data.split(None, 1)[1]
    await cq.answer(runtime, show_alert=True)


@shizuchat.on_callback_query(filters.regex("forceclose"))
